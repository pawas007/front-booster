...
const files = {
    ...
    jsPath: 'app/js/**/*.js',
    imgPath: "app/img/**/*.{jpg,jpeg,png,svg,gif}"
};
...
function scssTask() {
    return src(files.scssPath, {sourcemaps: true}) // set source and turn on sourcemaps
        ...
        .pipe(dest('dist/assets/style')); // put final CSS in dist folder
}
...
exports.default = series(parallel(scssTask, jsTask) /*cacheBustTask*/, imgTask);
